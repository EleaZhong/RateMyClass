...
// Changes needed: fix value submitting, add appbar
                    ...
                    <form>
                        <Grid container spacing={4} justify="center">
                            <Grid container item xs={12}>
                                <Grid item xs={6} md={6}>
                                    <FormControl id="select-control">
                                        ...
                                        <Select labelId='class-select-label' required autoWidth  defaultValue={-1} id="class-select">
                            ...
                            <Grid item xs={12} md={12}>
                                ...
                                <Slider required labelId = "rating-slide-label" defaultValue={0} min={-5} max={5} step={1} marks={marks} valueLabelDisplay="auto"/>
                            </Grid>
                            ...
                            <Grid item xs={12} md={6}>
                                ...
                                <TextField labelId = "professor-label"/>
                            </Grid>
                            ...
                            <Grid item xs={12} md={12}>
                                <Button variant ="contained" 
                                    onClick={ 
                                        () => {
                                            console.log(document.querySelector("#class-select").value);
                                            if(document.querySelector("#class-select").value == null || document.querySelector("#class-select").value == -1){
